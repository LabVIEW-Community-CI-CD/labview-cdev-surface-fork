...
Describe 'Release control plane workflow contract' {
    ...
    It 'runs autonomous control-plane runtime and uploads report' {
        ...
        $script:workflowContent | Should -Match 'Write-ReleaseControlPlaneDecisionTrail\.ps1'
        ...
        $script:workflowContent | Should -Match 'release-control-plane-decision-trail\.json'
    ...
    It 'implements mode sequencing, semver promotion guards, and semver tag planning' {
        ...
        $script:runtimeContent | Should -Match 'Resolve-CliDependencyGatePolicy'
        $script:runtimeContent | Should -Match 'Resolve-CliDependencyGateEnforcementMode'
        ...
        $script:runtimeContent | Should -Match 'Invoke-CliDependencyGate\.ps1'
        $script:runtimeContent | Should -Match 'cli_dependency_gate'
        $script:runtimeContent | Should -Match 'hard_block'
        $script:runtimeContent | Should -Match 'warn_only'
        $script:runtimeContent | Should -Match 'cli_dependency_gate_failed'
