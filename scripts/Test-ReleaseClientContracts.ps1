...
if ($null -ne $releaseClient) {
    ...
    Add-Check -Name 'ops_policy_decision_trail_schema_version' -Passed ([string]$releaseClient.ops_control_plane_policy.decision_trail.schema_version -eq '1.0') -Detail ([string]$releaseClient.ops_control_plane_policy.decision_trail.schema_version)
    Add-Check -Name 'ops_policy_decision_trail_artifact_name_prefix' -Passed ([string]$releaseClient.ops_control_plane_policy.decision_trail.artifact_name_prefix -eq 'release-control-plane-decision-trail') -Detail ([string]$releaseClient.ops_control_plane_policy.decision_trail.artifact_name_prefix)
    Add-Check -Name 'ops_policy_decision_trail_hash_algorithm' -Passed ([string]$releaseClient.ops_control_plane_policy.decision_trail.hash_algorithm -eq 'sha256') -Detail ([string]$releaseClient.ops_control_plane_policy.decision_trail.hash_algorithm)
    Add-Check -Name 'ops_policy_decision_trail_include_state_machine' -Passed ([bool]$releaseClient.ops_control_plane_policy.decision_trail.include_state_machine) -Detail ([string]$releaseClient.ops_control_plane_policy.decision_trail.include_state_machine)
    Add-Check -Name 'ops_policy_decision_trail_include_rollback_orchestration' -Passed ([bool]$releaseClient.ops_control_plane_policy.decision_trail.include_rollback_orchestration) -Detail ([string]$releaseClient.ops_control_plane_policy.decision_trail.include_rollback_orchestration)
    ...
    Add-Check -Name 'ops_policy_cli_dependency_gate_enabled' -Passed ([bool]$releaseClient.ops_control_plane_policy.cli_dependency_gate.enabled) -Detail ([string]$releaseClient.ops_control_plane_policy.cli_dependency_gate.enabled)
    Add-Check -Name 'ops_policy_cli_dependency_gate_hard_block_modes_promote_prerelease' -Passed (@($releaseClient.ops_control_plane_policy.cli_dependency_gate.hard_block_modes) -contains 'PromotePrerelease') -Detail ([string]::Join(',', @($releaseClient.ops_control_plane_policy.cli_dependency_gate.hard_block_modes)))
    Add-Check -Name 'ops_policy_cli_dependency_gate_hard_block_modes_promote_stable' -Passed (@($releaseClient.ops_control_plane_policy.cli_dependency_gate.hard_block_modes) -contains 'PromoteStable') -Detail ([string]::Join(',', @($releaseClient.ops_control_plane_policy.cli_dependency_gate.hard_block_modes)))
    Add-Check -Name 'ops_policy_cli_dependency_gate_hard_block_modes_full_cycle' -Passed (@($releaseClient.ops_control_plane_policy.cli_dependency_gate.hard_block_modes) -contains 'FullCycle') -Detail ([string]::Join(',', @($releaseClient.ops_control_plane_policy.cli_dependency_gate.hard_block_modes)))
    Add-Check -Name 'ops_policy_cli_dependency_gate_warn_only_modes_validate' -Passed (@($releaseClient.ops_control_plane_policy.cli_dependency_gate.warn_only_modes) -contains 'Validate') -Detail ([string]::Join(',', @($releaseClient.ops_control_plane_policy.cli_dependency_gate.warn_only_modes)))
    Add-Check -Name 'ops_policy_cli_dependency_gate_warn_only_modes_canary_cycle' -Passed (@($releaseClient.ops_control_plane_policy.cli_dependency_gate.warn_only_modes) -contains 'CanaryCycle') -Detail ([string]::Join(',', @($releaseClient.ops_control_plane_policy.cli_dependency_gate.warn_only_modes)))
    Add-Check -Name 'ops_policy_cli_dependency_gate_runtime_publish_workflow' -Passed ([string]$releaseClient.ops_control_plane_policy.cli_dependency_gate.runtime_publish_workflow -eq 'publish-cli-runtime-image') -Detail ([string]$releaseClient.ops_control_plane_policy.cli_dependency_gate.runtime_publish_workflow)
    Add-Check -Name 'ops_policy_cli_dependency_gate_attestation_artifact' -Passed ([string]$releaseClient.ops_control_plane_policy.cli_dependency_gate.runtime_attestation_artifact -eq 'cli-dependency-attestation') -Detail ([string]$releaseClient.ops_control_plane_policy.cli_dependency_gate.runtime_attestation_artifact)
    Add-Check -Name 'ops_policy_cli_dependency_gate_required_asset_win' -Passed (@($releaseClient.ops_control_plane_policy.cli_dependency_gate.required_assets) -contains 'cdev-cli-win-x64.zip') -Detail ([string]::Join(',', @($releaseClient.ops_control_plane_policy.cli_dependency_gate.required_assets)))
    Add-Check -Name 'ops_policy_cli_dependency_gate_required_asset_linux' -Passed (@($releaseClient.ops_control_plane_policy.cli_dependency_gate.required_assets) -contains 'cdev-cli-linux-x64.tar.gz') -Detail ([string]::Join(',', @($releaseClient.ops_control_plane_policy.cli_dependency_gate.required_assets)))
